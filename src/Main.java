...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        saveClassToFile.saveClassToFile(class1, "file.txt", false);
        saveClassToFile.saveClassToFile(class2, "file.txt", true);

        LoadClassFromFile loadClassFromFile = new LoadClassFromFile();
        ArrayList<Class> classes1 = loadClassFromFile.loadClassFromFile("file.txt");
        for (Class cls : classes1) {
            System.out.println(cls.getClassNumber());
